    ...
    return {
        ...
        callAjax :function(settings) {
            var config = {
                ...
                error: function() {
                    $("<div>OOPS !! Server request failed.</div>").dialog({
                        resizable: false,
                        height:140,
                        modal: true,
                ...
                beforeSend:function() {
                    ITL.plugin.NotificationMessage.showNotification();
                },
                complete:function() {
                    ITL.plugin.NotificationMessage.hideNotification();
                }
            };
         ...
         * Then it will produce the url - http://localhost:8080/ITL/item/list
         */
        getUrl : function(elm) {
            return ITL.CMSURL + elm.attr("href");
        },
        /**
         ...
         *    @return void
         * Example :
         *  ITL.utility.checkAll({selector:'#checkBtn',checkEl:'.checkElm',afterShow:function(){
         *         ... do something....
         },isCheckbox:true)
         */
         ...
         *    @return void
         * Example :
         *  ITL.utility.unCheckAll({selector:'#checkBtn',checkEl:'.checkElm',afterShow:function(){
         *         ... do something....
         },isCheckbox:true)
         */
