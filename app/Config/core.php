 ...
 */
Configure::write('Security.salt', 'Xtibsd83948Xbgfet1452141Ddfabrxew38de33zf');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
Configure::write('Security.cipherSeed', '65545687871258965774535896851');
