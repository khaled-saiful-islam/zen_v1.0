...
<fieldset>
    ...
    <div class="work-order form">
        ...
        <div style="width: 39%; text-align: right;">
            <div><b>Total Weight: <span id="total_weight"></span></b>
            </div>
        </div>								

        <div align="left" style="padding-bottom:15px">
            <?php
            echo $this->Html->link("Add Skid", "javascript:void(0)", array(
                "class" => 'btn btn-info',
                "escape" => false,
        ...
        <div class="align-left align-top-margin">
<?php echo $this->Html->link('Cancel', array( 'action' => 'container_index' ), array( 'class' => 'btn btn-success btn-padding', 'label' => false, 'value' => 'Cancel' )); ?>
        </div>
    </div>
