...
<div class="quotes report-print">
    <fieldset>
        <legend style="border-bottom-color: #fff;">
            ...
            <div style="color: red; font-size: 22px; font-weight: bold; width: 245px; float: right;" class="text-right"><?php echo $this->InventoryLookup->findProductionTime($quote['Quote']['delivery']); ?></div>
        </legend>
