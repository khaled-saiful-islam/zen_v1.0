...
<div class="quotes report-print" style="top: -55px;">
    ...
    <fieldset style="position: relative; top: -65px;">
        <legend style="width: 1000px; border-bottom-color: #fff; color: #403c3d; font-size: 21px;" class="text-right sub-title"><?php echo $reportTitle; ?> For <?php echo h($quote['WorkOrder']['work_order_number']); ?></legend>
