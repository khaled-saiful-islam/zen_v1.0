<div class="quotes form form-margin-bottom">
  ...
  echo $this->element('Forms/Quote/' . $sub_form['from'], array('edit' => $edit, 'section' => $section, 'main_item_list' => $main_item_list, 'price_list' => $price_list, 'title_list' => $title_list));
  ?>
  ...
  <?php } else { ?>
    <div class="align-left align-top-margin"><?php //pr($sub_form['detail']); ?>
