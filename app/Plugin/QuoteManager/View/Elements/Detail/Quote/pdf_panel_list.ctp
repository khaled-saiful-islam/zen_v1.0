...
//                $resources = $item->find('all', array('conditions' => array('Item.id' => $all_items_list, 'Item.item_department_id' => $report_department_list), 'order' => array('Item.item_title')));
    ...
    foreach( $report_items2 as $ri ) {
        ...
        <div class="tab-content">
                    ...
                    <tr>
                        ...
                        <td style="width: 40%;">
                            <div style="text-align: right; width: 100%;">
                                ...
                                <br/>
                                <span style="font-size: 18px; width: 100%; display: block; margin-top: 10px;" class="report-title">
            ...
            <div style="position: relative; border-top: 1px dashed #acacac; border-bottom: 1px dashed #acacac; margin-bottom: 10px;">
                <table style="width: 100%;">
                    <tr>
                        <td style="width: 50%;">
                            <div class="first_div">
            ...
            <div>
                <table style="width: 100%;">
                    <tr class="dashed-underline">
                        ...
                        <th class="text-left" style="width: 240px;">Code</th>
                    ...
                    if( !empty($ri) ) {
                        foreach( $ri as $report_item ) {
                            ...
                            <tr>
                                ...
                                <td class="text-left" style="width: 240px;"><?php echo $report_item['code']; ?></td>
                        ...
                        ?>
                        <tr>
                            <td class="text-center" colspan="4">There is no panel</td>
                        </tr>
                        <?php
                    }
                    ?>
