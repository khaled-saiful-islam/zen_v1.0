...
<page>
    ...
    <div class="tab-content">
        ...
        <div style="font-size: 18px; margin-top: 20px; margin-bottom: 20px; text-decoration: underline; font-weight: bold;" class="sub-section">Cabinet Backs</div>

        <div>
            <table style="width: 100%;">
                <tr class="dashed-underline">
                    <th style="width: 80px;" class="text-left">Qty</th>
                    <th style="width: 120px;" class="text-left">Code</th>
                    <th style="width: 400px;" class="text-left">Description</th>
                    <th style="width: 100px;" class="text-center">Width X Length</th>
                </tr>
                ...
                if( !empty($report_items) ) {
                    ...
                    ?>
                    <tr>
                        <td class="text-center" colspan="4">There is no cabinet backs</td>
                    </tr>
                    <?php
                }
                ?>
