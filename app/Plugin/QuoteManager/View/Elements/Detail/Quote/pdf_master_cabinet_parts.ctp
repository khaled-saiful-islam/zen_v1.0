...
<page>
            ...
            <tr>
                ...
                <td style="width: 40%;">
                    <div style="text-align: right;">
                        ...
                        <br/>
                        <span style="font-size: 15px; width: 100%; display: block; margin-top: 10px;" class="report-title">
    ...
    <div class="tab-content">
        ...
        <div style="font-size: 16px; margin-top: 20px; margin-bottom: 20px; text-decoration: underline; font-weight: bold;" class="sub-section">Master Cabinet Parts List</div>

        <div>
            <table style="width: 100%;">
                <tr class="dashed-underline">
                    <th class="text-left" style="width: 60px;">Qty</th>
                    <th class="text-left" style="width: 200px;">Code</th>
                ...
                if( !empty($report_items) ) {
                    foreach( $report_items as $report_item ) {
                        ...
                        <tr>
                            ...
                            <td class="text-left" style="width: 200px;"><?php echo $report_item['code']; ?></td>
                    ...
                    ?>
                    <td class="text-center" colspan="4">There is no master cabinet parts</td>
                    <?php
                }
                ?>
            </table>
