...
<page>
                ...
                <td style="width: 40%;">
                    <div style="text-align: right;">
                        ...
                        <span style="font-size: 23px; width: 100%; display: block; margin-top: 10px;" class="report-title">
                            <?php echo $reportTitle . " for " . $quote['WorkOrder']['work_order_number']; ?>
                        </span>
                        <br/>
    ...
    <div class="tab-content">
        ...
        <div style="font-size: 18px; margin-top: 20px; margin-bottom: 20px; text-decoration: underline; font-weight: bold;" class="sub-section">Cabinet Shelfs</div>

        <div>
            <table style="width: 100%;">
                <tr class="dashed-underline">
                    <th class="text-left" style="width: 80px;">Qty</th>
                    <th class="text-left" style="width: 120px;">Code</th>
                    <th class="text-left" style="width: 400px;">Description</th>
                    <th class="text-left" style="width: 100px;">Width X Length</th>
                </tr>
                ...
                if( !empty($report_items) ) {
                    foreach( $report_items as $report_item ) {
                        ?>
                        <tr>
                            <td style="width: 80px;" class="text-left"><?php echo $report_item['quantity']; ?></td>
                            <td style="width: 120px;" class="text-left"><?php echo $report_item['code']; ?></td>
                            <td style="width: 400px;" class="text-left"><?php echo $report_item['description']; ?></td>
                            <td style="width: 100px;" class="text-center"><?php echo "{$report_item['width']} X {$report_item['length']}"; ?></td>
                        </tr>
                        <?php
                    }
                }
                    ...
                    ?>
                    <tr>
                        <td class="text-center" colspan="4">There is no shelf</td>
                    </tr>
                    <?php
                }
                ?>
