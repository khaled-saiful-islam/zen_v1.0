...
<page>
    ...
    <div class="tab-content">
        ...
        <div style="font-size: 18px; margin-top: 20px; margin-bottom: 20px; text-decoration: underline; font-weight: bold;" class="sub-section">Hardware List</div>

        <div>
            <table style="width: 100%;">
                <tr class="dashed-underline">
                    <th class="text-left" style="width: 60px;">Qty</th>
                    <th class="text-left" style="width: 300px;">Code</th>
                    <th class="text-left" style="width: 300px;">Description</th>
                    <th class="text-left" style="width: 50px;">UPC</th>
                </tr>
                ...
                if( !empty($report_items) ) {
                    foreach( $report_items as $report_item ) {
                        ...
                        <tr>
                            ...
                            <td class="text-left" style="width: 300px;"><?php echo $report_item['code']; ?></td>
                            <td class="text-left" style="width: 300px;"><?php echo $report_item['description']; ?></td>
                            <td class="text-left" style="width: 50px;">N/A</td>
                        </tr>
                        <?php
                    }
                }
                    ...
                    ?>
                    <td class="text-center" colspan="4">There is no hardware</td>
                    <?php
                }
                ?>
            </table>
