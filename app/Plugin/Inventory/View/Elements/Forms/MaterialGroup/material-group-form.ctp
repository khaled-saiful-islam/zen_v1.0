...
<div class="item form">
    <?php
    echo $this->Form->create('MaterialGroup', array( 'inputDefaults' => array( 'label' => false, 'div' => false ), 'class' => 'item-core-form ajax-form-submit', 'type' => 'post' ));
    echo $this->element('Forms/MaterialGroup/main-form');
    ?>
