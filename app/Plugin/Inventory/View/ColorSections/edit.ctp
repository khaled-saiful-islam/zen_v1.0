...
<?php echo $this->Form->create('ColorSection');?>
	<fieldset>
		<legend><?php echo __('Edit Color Section'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ColorSection.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('ColorSection.id'))); ?></li>
