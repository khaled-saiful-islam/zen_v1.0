...
<?php echo $this->Form->create('ColorMaterial');?>
	<fieldset>
		<legend><?php echo __('Edit Color Material'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ColorMaterial.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('ColorMaterial.id'))); ?></li>
