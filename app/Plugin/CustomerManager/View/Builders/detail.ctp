<div class="customers view">
  ...
  if (isset($modal) && $modal == "modal") {
    ...
    <?php echo $this->element('Detail/Customer/builder-basic-info'); ?>
  <?php } else { ?>
    <fieldset>
      <div style="float: left; width: 95%;"><legend><?php echo __($title_prefix . ': '); ?>&nbsp;
        ...
        <?php echo h($customer['Customer']['last_name']); ?></legend>
			...
			<div class="report-buttons" style="float: right;">
				<?php
				echo $this->Html->link(
								'', array('controller' => 'builders', 'action' => 'print_detail', $customer['Customer']['id']), array('class' => 'icon-print open-link', 'data_target' => 'item_report', 'title' => 'Print Detail Information')
				);
				?>
			</div>
			<div style="clear: both;"></div>
      <ul class="nav nav-tabs form-tab-nav" id="item-form-tab-nav">
        <li class="active"><a href="#builder-basic-info" data-toggle="tab"><?php echo __($title_prefix . ' Information'); ?></a></li>
      ...
      <div class="tab-content">
        <fieldset id="builder-basic-info" class="tab-pane active">
          <?php echo $this->element('Detail/Customer/builder-basic-info', array('edit' => true)); ?>
        </fieldset>
