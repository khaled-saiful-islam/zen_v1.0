<div class="detail actions">
	<?php //echo $this->Html->link('Add Project', array('controller' => 'builder_projects', 'action' => 'addProject',$customer['Customer']['id'] ), array('data-target' => '#sub-project-list', 'class' => 'ajax-sub-content btn btn-success btn-padding', 'title' => __('Edit'))); ?>
